...
export function Hero() {
    return (
        <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-background">
            ...
            <div className="absolute top-0 right-0 w-[40%] h-full bg-primary/3 -skew-x-3 transform origin-top-right transition-transform duration-1000 hidden lg:block" />
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-8 md:gap-10 opacity-70">
                            <div className="flex flex-col">
                                <span className="text-xl font-display font-bold text-primary">2020</span>
                                <span className="text-[10px] uppercase tracking-widest font-bold">Founded</span>
                            </div>
                            <div className="flex flex-col">
                                <span className="text-xl font-display font-bold text-primary">6</span>
                                <span className="text-[10px] uppercase tracking-widest font-bold">Pillars</span>
                            </div>
                            <div className="flex flex-col">
                                <span className="text-xl font-display font-bold text-primary">$1,600+</span>
